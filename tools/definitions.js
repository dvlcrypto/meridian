...
2. No user spec → use active strategy. Current default is Evil Panda: single-sided SOL spot, price_range_pct=80, token-level OKX volume24H >= $750k, marketCap >= $200k, and 5m Supertrend green/price above.
